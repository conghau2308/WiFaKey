...
class Proto_LDPC:
    ...
    def __init__(self, N, m, Z):
        ...
        code_PCM0 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph", "BaseGraph2_Set0.txt"), int, delimiter='\t')

        code_PCM1 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph", "BaseGraph2_Set1.txt"), int, delimiter='\t')

        code_PCM2 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph", "BaseGraph2_Set2.txt"), int, delimiter='\t')

        code_GM_16 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph_GM", "LDPC_GM_BG2_16.txt"), int, delimiter=',')

        code_GM_3 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph_GM", "LDPC_GM_BG2_3.txt"), int, delimiter=',')

        code_GM_10 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph_GM", "LDPC_GM_BG2_10.txt"), int, delimiter=',')

        code_GM_6 = np.loadtxt(os.path.join(_DATA_DIR, "BaseGraph_GM", "LDPC_GM_BG2_6.txt"), int, delimiter=',')
